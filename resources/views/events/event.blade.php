<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
            <form id="eventForm" method="POST" action="{{ route('events.update', $event) }}" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-4">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="title" class="form-label">Titre <span class="text-danger">*</span></label>
                    <input type="text" class="form-control rounded @error('title') is-invalid @enderror" id="title" name="title" value="{{ $event->title }}" required>
                    @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                    <textarea class="form-control rounded @error('description') is-invalid @enderror" id="description" name="description" rows="3" required>{{ $event->description }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select rounded @error('region_id') is-invalid @enderror" id="region_id" name="region_id" required>
                        ...
                        @foreach($regions as $region)
                            <option value="{{ $region->id }}" data-cities='@json($region->cities)' {{ $event->region_id == $region->id ? 'selected' : '' }}>{{ $region->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select rounded @error('city_id') is-invalid @enderror" id="city_id" name="city_id" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control rounded-start @error('place') is-invalid @enderror" id="place" name="place" value="{{ $event->place }}" required placeholder="Sélectionner ou saisir le lieu">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control rounded @error('date') is-invalid @enderror" id="date" name="date" value="{{ $event->date }}" required>
                        @error('date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="time" class="form-label">Heure <span class="text-danger">*</span></label>
                        <input type="time" class="form-control rounded @error('time') is-invalid @enderror" id="time" name="time" value="{{ $event->time }}" required>
                ...
                <div class="mb-3">
                    ...
                    @if($event->image)
                        <img src="{{ asset('images/events/' . $event->image) }}" alt="Image de l'événement" class="img-fluid mb-2 w-25">
                    @endif
                    <input type="file" class="form-control rounded @error('event_image') is-invalid @enderror" id="event_image" name="event_image" accept="image/*" value="{{ $event->event_image }}">
                ...
                @if(Auth::user()->role === 'admin')
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded @error('organizer_title') is-invalid @enderror" id="organizer_title" name="organizer_title" value="{{ $event->organizer_title }}" required>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary px-4" id="openConfirmModal">
                        <i class="bi bi-check-circle me-2"></i>Modifier l'événement
                    </button>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmModalLabel">Confirmer la modification de l'événement</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        Merci de vérifier les informations de l'événement avant de confirmer la modification.
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                    <button type="button" id="confirmSubmit" class="btn btn-success">Confirmer et modifier</button>
                </div>
            </div>
        </div>
    </div>
