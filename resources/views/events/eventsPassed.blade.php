                        ...
                        <tbody>
                            @forelse($events as $event)
                                <tr>
                                    ...
                                    <td>{{ $event->time }}</td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-info" title="Voir" data-bs-toggle="modal" data-bs-target="#viewPassedEventModal{{ $event->id }}">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                    </td>
                                </tr>
                                <!-- View Modal -->
                                <div class="modal fade" id="viewPassedEventModal{{ $event->id }}" tabindex="-1" aria-labelledby="viewPassedEventModalLabel{{ $event->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="viewPassedEventModalLabel{{ $event->id }}">
                                                    <i class="bi bi-calendar2-check me-2 text-secondary"></i>Détails de l'événement passé
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <h4 class="fw-bold text-secondary mb-3">{{ $event->title }}</h4>
                                                        <div class="mb-3">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-4 text-muted">
                                        ...
                                        {{ __('Aucun événement passé trouvé') }}
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
